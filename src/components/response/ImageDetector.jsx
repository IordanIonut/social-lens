...
const ImageDetector = ({ value, name }) => {
        ...
        <div>
          <div className="self-stretch h-[55px] flex flex-row items-end justify-start relative">
            ...
            <div className="h-full w-full absolute !m-[0] top-[0px] left-[0px]">
              ...
              <div className="absolute top-[50px] left-[120px] text-2xl w-full text-justify ">
                {value?.unsafe}
              </div>
            </div>
          </div>
          ...
          {objects.map((item, key) => (
            <div
              key={key}
              className="flex flex-col items-center w-[400px] justify-start py-0 px-10 border-l-[3px] border-dashed border-[#443f76]"
            >
              <div className="w-[365px] flex flex-row items-start justify-start py-0 box-border">
                <div className="h-[55px] flex-1 flex flex-row items-end justify-center relative">
                  ...
                  <div className="relative text-2xl">{item?.label}</div>
                </div>
              </div>
